...
#@ Double (label = "Surface Threshold", value = 12500) par_surface_threshold
#@ Double (label = "Lipid Threshold", value = 900) par_lipid_threshold
...
// Version 1.1                                                    //
// Changelog:                                                     //
// 1.0.1 Store Settings                                           //
// 1.1 No Z-stack                                                 //
//     2 instead of 3 channels                                    //
//----------------------------------------------------------------//
List.clear();
List.set("Version",1.1);
List.set("Input directory",par_input);
List.set("Output directory",par_output);
List.set("File suffix",par_suffix);
List.set("Surface Threshold",par_surface_threshold);
List.set("Lipid Threshold",par_lipid_threshold);
...
File.saveString(settings, par_output+File.separator+"settings.txt");
